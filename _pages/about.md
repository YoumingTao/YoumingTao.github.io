...
I am a postdoctoral researcher with the [Telecommunication Networks (TKN) Group](https://www.tkn.tu-berlin.de/) at the [School of Electrical Engineering and Computer Science](https://www.tu.berlin/eecs/), [TU Berlin](https://www.tu.berlin/). I completed my PhD under the supervision of [Prof. Dr.-Ing. habil. Falko Dressler](https://www2.tkn.tu-berlin.de/team/dressler/), [Prof. Dongxiao Yu](https://scholar.google.com/citations?user=hiQxuHYAAAAJ&hl=en), and [Prof. Xiuzhen (Susan) Cheng](https://scholar.google.com/citations?user=O1yGhH0AAAAJ&hl=en), graduating with *summa cum laude* in 2025. I am also very fortunate to work closely with [Prof. Di Wang](https://shao3wangdi.github.io/), who directs the [PRADA Lab](https://pradalab1.github.io/) at [KAUST](https://www.kaust.edu.sa/en/).
...
<ul style="list-style: none; padding-left: 0;">
  ...
  <li style="display: table-row; margin-bottom: 10px;">
    ...
    <div style="display: table-cell; text-align: left;">
      ...
      <br><em>The 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP 2026 Findings)</em>
    </div>
  </li>
...
<ul style="list-style: none; padding-left: 0;">
  ...
  <li style="display: table-row; margin-bottom: 10px;">
    ...
    <div style="display: table-cell; text-align: left;">
      Nearly-Tight Bounds for Private Stochastic Convex Optimization and Sparse Learning under Heavy Tails <a href="https://cje.ejournal.org.cn/article/doi/10.23919/cje.2025.00.225">[link]</a>  
  ...
  <li style="display: table-row; margin-bottom: 10px;">
    ...
    <div style="display: table-cell; text-align: left;">
      ...
      <br><em>Theoretical Computer Science (Volume 1026, February 2025, 114987)</em>  
